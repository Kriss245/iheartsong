    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <ol class="breadcrumb">
                    <li>
                        <a href="javascript:void(0)" onclick="location.href='{{ url('/home')}}'" title="Home">
        ...
        <div class="table-responsive">
            ...
            <table id="tracks-table" frame="box" class="display table-hover table-striped" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <th data-orderable="false">Audio File</th>
                </tr>
                </thead>
                ...
                @foreach($tracks as $track)
                    <tr id="track{{$track->id}}">
                        ...
                        <td>
                            <audio controls>
                                <source src="{{ asset('songs/'.$track->audio_file) }}" type="audio/mpeg">
            ...
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        {{ Form::open(array('url'=>'track.add','name'=>'trackForm','id'=>'trackForm','class'=>'form-horizontal form-label-left', 'enctype'=>'multipart/form-data')) }}
                        ...
                        <div class="form-group">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <input type="file" class="form-control" name="audio_file" id="audio_file" accept=".mp3,.wav">
                            </div>
                        </div>
