    ...
    <nav class="navbar navbar-default">
        <div class="container-fluid">
            <div class="navbar-header">
                <!-- Tambahkan gambar/logo di dalam navbar-header -->
                ...
                <a class="navbar-brand" href="{{ url('#') }}" style="padding-top: 5px; padding-bottom: 5px;">
                    <img src="{{ asset('img/iheartsong.png') }}" alt="Logo iheartsong" style="width: 50px; height: 50px; display: inline-block; margin-right: 2px; margin-top: -10px;">
                    <span style="display: inline-block; margin-top: -10px;">iheartsong</span>
                </a>                      
            </div>
